...
List<FarmerRegModel?>? farmerRegModelFromJson(String str) =>
    json.decode(str) == null
        ? []
        : List<FarmerRegModel?>.from(
            json.decode(str)!.map((x) => FarmerRegModel.fromJson(x)));

String farmerRegModelToJson(List<FarmerRegModel?>? data) => json.encode(
